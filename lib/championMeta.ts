...
export const CHAMPION_META: Record<string, ChampionMeta> = {
  ...
  Zaahen: { phase: "mid-late", archetypes: ["skirmish", "dive", "sustain"], cc: "hard", mobility: "medium", metaTiers: { top: "S+", jungle: "A" } }, // 25.23 release — Darkin fighter, launched overtuned
...
export function serializeMetaOverride(override: MetaOverride): string {
  ...
  for (const alias of sortedAliases) {
    ...
    for (const l of ["top", "jungle", "middle", "bottom", "support"] as Lane[]) {
...
export function parseMetaOverride(
  ...
  if (envelope.tiers !== undefined) {
    if (typeof envelope.version === "number" && envelope.version > META_EXPORT_VERSION) {
  ...
  if (rawTiers == null || typeof rawTiers !== "object" || Array.isArray(rawTiers)) {
    return {
      override: null,
      error: "Expected `tiers` to be an object mapping champion alias → lane tiers",
      championCount: 0,
      skippedEntries: 0,
    };
  }
  ...
  for (const [alias, value] of Object.entries(rawTiers as Record<string, unknown>)) {
    ...
    let kept = 0;
    for (const [laneKey, tierVal] of Object.entries(value as Record<string, unknown>)) {
      if (!VALID_LANES.has(laneKey as Lane)) continue;
      if (typeof tierVal !== "string" || !VALID_TIERS.has(tierVal as MetaTier)) continue;
...
export const CHAMPION_SYNERGIES: Synergy[] = [
  ...
  { champs: ["Smolder", "TahmKench"], bonus: 2, tag: "Devour + Stacking Carry" },
  ...
  { champs: ["Maokai", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Amumu", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Alistar", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Rell", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Galio", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Hecarim", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["JarvanIV", "AurelionSol"], bonus: 2, tag: "Engage + Singularity" },
  { champs: ["JarvanIV", "MissFortune"], bonus: 2, tag: "Engage + Bullet Time" },
  ...
  { champs: ["Diana", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Zac", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["KSante", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Skarner", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Lillia", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  { champs: ["Lillia", "Mel"], bonus: 2, tag: "Engage + Reflection" },
  { champs: ["Nautilus", "AurelionSol"], bonus: 2, tag: "Engage + Singularity" },
  { champs: ["Nautilus", "Aurora"], bonus: 2, tag: "Engage + Cosmic Beyond" },
  { champs: ["Nautilus", "Hwei"], bonus: 2, tag: "Engage + Spiraling Despair" },
  { champs: ["Nautilus", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Pantheon", "AurelionSol"], bonus: 2, tag: "Engage + Singularity" },
  { champs: ["Pantheon", "MissFortune"], bonus: 2, tag: "Engage + Bullet Time" },
  { champs: ["Pantheon", "Aurora"], bonus: 2, tag: "Engage + Cosmic Beyond" },
  { champs: ["Pantheon", "Hwei"], bonus: 2, tag: "Engage + Spiraling Despair" },
  { champs: ["Pantheon", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Vi", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Volibear", "AurelionSol"], bonus: 2, tag: "Engage + Singularity" },
  { champs: ["Volibear", "MissFortune"], bonus: 2, tag: "Engage + Bullet Time" },
  { champs: ["Volibear", "Aurora"], bonus: 2, tag: "Engage + Cosmic Beyond" },
  { champs: ["Volibear", "Hwei"], bonus: 2, tag: "Engage + Spiraling Despair" },
  { champs: ["Volibear", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Lissandra", "MissFortune"], bonus: 2, tag: "Engage + Bullet Time" },
  { champs: ["Lissandra", "Aurora"], bonus: 2, tag: "Engage + Cosmic Beyond" },
  { champs: ["Lissandra", "Hwei"], bonus: 2, tag: "Engage + Spiraling Despair" },
  { champs: ["Lissandra", "Velkoz"], bonus: 2, tag: "Engage + Lifeform Disintegration" },
  ...
  { champs: ["Aphelios", "TahmKench"], bonus: 2, tag: "Sustain + Late Scaling" },
  ...
  { champs: ["Malphite", "Aphelios"], bonus: 2, tag: "Frontline + Hyper-Carry" },
  ...
  { champs: ["Malphite", "Tristana"], bonus: 2, tag: "Frontline + Hyper-Carry" },
  ...
  { champs: ["Volibear", "Aphelios"], bonus: 2, tag: "Frontline + Hyper-Carry" },
  ...
  { champs: ["Volibear", "Tristana"], bonus: 2, tag: "Frontline + Hyper-Carry" },
  ...
  { champs: ["TahmKench", "Kalista"], bonus: 2, tag: "Frontline + Hyper-Carry" },
  { champs: ["TahmKench", "Tristana"], bonus: 2, tag: "Frontline + Hyper-Carry" },
  { champs: ["TahmKench", "Caitlyn"], bonus: 2, tag: "Frontline + Hyper-Carry" },
  ...
  { champs: ["Kindred", "Veigar"], bonus: 2, tag: "Lamb's Respite + Cage zone" },
  { champs: ["Kindred", "Pantheon"], bonus: 2, tag: "Global pair + Lamb's Respite" },
  { champs: ["Leblanc", "Maokai"], bonus: 2, tag: "Root + Sigil chain" },
  { champs: ["Leblanc", "JarvanIV"], bonus: 2, tag: "Cataclysm + Sigil chain" },
  { champs: ["Malzahar", "JarvanIV"], bonus: 2, tag: "Cataclysm + Suppression" },

...
- **Hall of Seasons** — `SeasonHistoryEntry` résumés: champions, full placement arrays, All-Pro, `playerCareers`, transfer logs, phase rosters, meta start vs end, H2H matrices, dynasty tiers, rivalries.
